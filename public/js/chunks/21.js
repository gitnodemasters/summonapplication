...
/* harmony default export */ __webpack_exports__["default"] = ({
  computed: {
    i18n_locale_img: function i18n_locale_img() {
      ...
      if (locale === 'en') return __webpack_require__(/*! @assets/images/flags/en.png */ "./resources/assets/images/flags/en.png"); // else if (locale === 'pt') return require('@assets/images/flags/pt.png')
      // else if (locale === 'fr') return require('@assets/images/flags/fr.png')
      // else if (locale === 'de') return require('@assets/images/flags/de.png')
      else if (locale === 'br') return __webpack_require__(/*! @assets/images/flags/br.png */ "./resources/assets/images/flags/br.png");else return __webpack_require__(/*! @assets/images/flags/en.png */ "./resources/assets/images/flags/en.png");
    },
    getCurrentLocaleData: function getCurrentLocaleData() {
      var locale = this.$i18n.locale;
      if (locale === 'en') return {
        flag: 'us',
        lang: 'English' // else if (locale === 'pt') return { flag: 'br', lang: 'Portuguese' }
        // else if (locale === 'fr') return { flag: 'fr', lang: 'French'     }
        // else if (locale === 'de') return { flag: 'de', lang: 'German'     }

      };else if (locale === 'br') return {
        flag: 'br',
        lang: 'Arabic'
      };
    }
    ...
    [
      _c("p", [
        ...
        _c(
          ...
          {
            attrs: {
              href: "http://www.bfginternational.com/",
              target: "_blank",
              rel: "nofollow"
            }
          },
          [_vm._v("BFG International")]
        ),
        _vm._v(" "),
          ...
          _c(
            ...
            [
              _c("img", {
                staticClass: "h-4 w-5 mr-1",
                attrs: {
                  src: __webpack_require__(/*! @assets/images/flags/br.png */ "./resources/assets/images/flags/br.png"),
                  alt: "pt"
                }
              }),
              _vm._v("  Arabic")
                  ...
                  [
                    _c(
                      "li",
                      {
                        ...
                        on: {
                          click: function($event) {
                            _vm.$router.push("/email").catch(function() {})
                          }
                        }
                      },
                      [
                    ...
                    _c(
                      "li",
                      {
                        ...
                        on: {
                          click: function($event) {
                            _vm.$router.push("/todo").catch(function() {})
                          }
                        }
                      },
                      [
                    ...
                    _c(
                      "li",
                      {
                        ...
                        on: {
                          click: function($event) {
                            _vm.$router.push("/chat").catch(function() {})
                          }
                        }
                      },
                      [
...
/***/ "./resources/assets/images/flags/br.png":
/*!**********************************************!*\
  !*** ./resources/assets/images/flags/br.png ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = "/images/br.png?c8ed784973154ccc6849989e745351ea";

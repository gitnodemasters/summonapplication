        ...
        <div slot="no-body" class="full-page-bg-color">
          ...
          <div class="vx-row no-gutter justify-center items-center">
            ...
            <div class="vx-col hidden lg:block lg:w-1/2">
               <router-link tag="div" class="vx-logo cursor-pointer flex items-center justify-center" to="/pages/login">
              ...
              <span class="vx-logo-text text-primary ml-4">Summon Application</span>
              </router-link>
            </div>

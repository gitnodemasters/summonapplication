<template>
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
      ...
      <vs-dropdown-item @click="updateLocale('br')"><img class="h-4 w-5 mr-1" src="@assets/images/flags/br.png" alt="pt" /> &nbsp;Arabic</vs-dropdown-item>
    </vs-dropdown-menu>
  </vs-dropdown>
</template>
...
export default {
  computed: {
    i18n_locale_img () {
      ...
      else if (locale === 'br') return require('@assets/images/flags/br.png')
    ...
    getCurrentLocaleData () {
      ...
      else if (locale === 'br') return { flag: 'br', lang: 'Arabic'     }
    }
  },
  methods: {
    updateLocale (locale) {

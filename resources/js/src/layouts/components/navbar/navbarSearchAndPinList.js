...
export default {
  pages: {
    ...
    data: [
      ...
      // APPS
      {title: "Todo",                       url: "/todo",                          icon: "CheckSquareIcon",    is_bookmarked: true},
      {title: "Chat",                       url: "/chat",                          icon: "MessageSquareIcon",  is_bookmarked: true},
      {title: "Email",                      url: "/email",                         icon: "MailIcon",           is_bookmarked: true},
      {title: "Calendar",                   url: "/calendar",                       icon: "CalendarIcon",       is_bookmarked: true},

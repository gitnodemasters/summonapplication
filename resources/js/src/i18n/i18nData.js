...
export default {
  ...
  br: {
    ...
    Calendar: 'البريد الإلكتروني',
    FullCalendar: 'التقويم الكامل',
    SimpleCalendar: 'تقويم بسيط',
    Shop: 'متجر',
    ...
    CardColors: 'ألوان البطاقة',
    Table: 'الطاولة',
    agGridTable: 'جدول agGrid',
    Components: 'مكونات',
    Alert: 'إنذار',
    ...
    ChartsAndMaps: 'الرسوم البيانية والخرائط',
    ...
    demoTitle: 'عنوان البطاقة',
    demoText: 'كعكة السمسم تستقر كعكة الزنجبيل الدنماركية أحب خبز الزنجبيل. عناب فطيرة التفاح لاذع تمتص قطع الكعك الحلاوة الطحينية. كعكة الشوكولاتة كعكة الشوفان تيراميسو مرزباني السكر البرقوق. كعكة حلوى الشوفان الحلوة دونات دراجي فواكه حلوى غزل البنات بقطرات الليمون.'
  }
}
